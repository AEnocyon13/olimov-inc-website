...
export const content = {
  ja: {
    meta: {
      title: 'OLIMOV株式会社 — 日本と中央アジアのナレッジブローカー',
      description:
        '日本と中央アジアの間で、契約仲介・輸出入手続き・市場調査・IT技術支援を提供します。両国の言語と商習慣の壁を無くす。東京・六本木。',
    },
    ...
    hero: {
      ...
      title: ['中央アジアと日本との間で', 'リバースイノベーションを起こす。'],
      lead:
        '知識・貨物・技術を両方向から運びます。どちらの向きにも、言語と法制度と商習慣という同じ壁があります。',
      cta: '取引の相談をする',
      ctaSub: '通常3営業日以内に返信',
      axis: {
        left: '東京',
